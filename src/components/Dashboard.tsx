      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {guilds.length === 0 ? (
          <div className="bg-gray-900 border border-red-500/30 rounded-2xl p-12 text-center">
            ...
            <a
              href="https://discord.com/oauth2/authorize?client_id=1322592306670338129&permissions=8&response_type=code&redirect_uri=https%3A%2F%2Fdyse-dashboard.onrender.com%2Fapi%2Fcallback&integration_type=0&scope=identify+guilds+email+guilds.members.read+bot"
              target="_blank"
